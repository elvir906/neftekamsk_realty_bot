...
class message_texts():
    on = {
        ...
        + 'всё OK, то лимит будут увеличивать). Отправка осуществляется на '
        ...
        + 'ничего не трогайте, не давайте команды боту и даже не дышите '
        + 'в сторону бота.\n\n'
        ...
        + 'делаешь посты, потому что бот не хранит эти '
        + 'данные у себя.*\n\n'
        ...
        + '7. Предусмотрена возможность внедрения в код бота индивидуального '
        + 'дизайна постов за отдельную оплату.'
        + '8. Пользуясь функцией "vk-autopost", ты соглашаешься'
