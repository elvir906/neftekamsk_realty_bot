...
class message_texts():
    on = {
        ...
        'limit_entering_error':
        '❎ Ошибка при вводе значения лимита по стоймости.\n\nЗначение'
        + ' следует вводить цифрами без пробелов '
        + 'и разделителя "." '
        + 'и без указания единицы измерения.'
        + '\n\n✅ *Введи значение '
        ...
        'phone_number_entering_text_for_editing':
        '✏ *Введи свой номер '
        + 'телефона в формате '
        + '89ххххххххх* '
        + '(11 цифр номера, '
        ...
        'sorry_about_error':
        '❎ К сожалению, в работе бота произошла ошибка. '
        + 'Попробуй еще раз. '
        + 'Если ошибка повторится, напиши об этом '
        + '@davletelvir',

        'agency_entering_text':
        '✏ *В каком агентстве работаешь?*\n\n'
        + 'Если ты частный риелтор, то напиши '
        + '"Частный".\n\n'
        + '🙅‍♂️ Чтобы отменить внесение объекта, напиши "Стоп"',

        'area_entering_text':
        '✏ *Введи площадь, как в указано в '
        ...
        'start':
        '👋 Привет! Рад приветствовать тебя! Я храню в своей базе '
        + 'актуальные '
        ...
        'code_word_text':
        'Напиши слово "Риелтор"',

        'ad_post_description':
        'Введи описание к изображению',

        'buyer_phone_number_entering_text':
